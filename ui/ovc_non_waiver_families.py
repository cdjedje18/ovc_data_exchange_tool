...
from common.modules.ovc_data_exchange import non_family_exchange
...
def create_ovc_non_waiver_families_frame(parent, show_frame):
    ...
    ctk.CTkLabel(header, text="OVC Non-Waiver Families", font=ctk.CTkFont(size=20, weight="bold")).pack(side="left")
    ...
    def run_family_exchange():
        ...
        append_log(
            f"[INFO] Starting Non-Waiver Families Exchange | family='{execution_config.family_program['name']}' "
